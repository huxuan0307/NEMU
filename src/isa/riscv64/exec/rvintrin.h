...
static inline int32_t _rv64_zext_h(int32_t rs1) { int32_t rd; __asm__ ("zext.h  %0, %1" : "=r"(rd) : "r"(rs1)); return rd; }
#endif
...
#ifdef RVINTRIN_RV32
static inline int32_t _rv32_bcompress(int32_t rs1, int32_t rs2) { int32_t rd; __asm__ ("bcompress  %0, %1, %2" : "=r"(rd) : "r"(rs1), "r"(rs2)); return rd; }
static inline int32_t _rv32_bdecompress(int32_t rs1, int32_t rs2) { int32_t rd; __asm__ ("bdecompress  %0, %1, %2" : "=r"(rd) : "r"(rs1), "r"(rs2)); return rd; }
#endif

#ifdef RVINTRIN_RV64
static inline int32_t _rv32_bcompress(int32_t rs1, int32_t rs2) { int32_t rd; __asm__ ("bcompressw %0, %1, %2" : "=r"(rd) : "r"(rs1), "r"(rs2)); return rd; }
static inline int32_t _rv32_bdecompress(int32_t rs1, int32_t rs2) { int32_t rd; __asm__ ("bdecompressw %0, %1, %2" : "=r"(rd) : "r"(rs1), "r"(rs2)); return rd; }

static inline int64_t _rv64_bcompress(int64_t rs1, int64_t rs2) { int64_t rd; __asm__ ("bcompress  %0, %1, %2" : "=r"(rd) : "r"(rs1), "r"(rs2)); return rd; }
static inline int64_t _rv64_bdecompress(int64_t rs1, int64_t rs2) { int64_t rd; __asm__ ("bdecompress  %0, %1, %2" : "=r"(rd) : "r"(rs1), "r"(rs2)); return rd; }
#endif
...
static inline int32_t _rv32_bcompress(int32_t rs1, int32_t rs2)
{
...
static inline int32_t _rv32_bdecompress(int32_t rs1, int32_t rs2)
{
	uint32_t c = 0, i = 0, data = rs1, mask = rs2;
	while (mask) {
		uint32_t b = mask & ~((mask | (mask-1)) + 1);
...
static inline int64_t _rv64_bcompress(int64_t rs1, int64_t rs2)
{
...
static inline int64_t _rv64_bdecompress(int64_t rs1, int64_t rs2)
{
	uint64_t c = 0, i = 0, data = rs1, mask = rs2;
	while (mask) {
		uint64_t b = mask & ~((mask | (mask-1)) + 1);
...
static inline long _rv_bcompress     (long rs1, long rs2) { return _rv32_bcompress     (rs1, rs2); }
static inline long _rv_bdecompress     (long rs1, long rs2) { return _rv32_bdecompress     (rs1, rs2); }
...
static inline long _rv_bcompress     (long rs1, long rs2) { return _rv64_bcompress     (rs1, rs2); }
static inline long _rv_bdecompress     (long rs1, long rs2) { return _rv64_bdecompress     (rs1, rs2); }
